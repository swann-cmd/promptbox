...
export function FormModal({
  ...
  return (
    ...
    >
      <div
        className={`bg-white dark:bg-dark-bgSecondary rounded-3xl shadow-2xl w-full ${sizeClasses[size]} ${className}`}
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-dark-border">
          ...
          <button
            ...
            aria-label="关闭"
          >
            <svg className="w-5 h-5 text-gray-400 dark:text-dark-textSecondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Footer */}
        {footer && (
          <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 dark:border-dark-border bg-gray-50/50 dark:bg-dark-bg/50 rounded-b-3xl">
            {footer}
          </div>
        )}
      </div>
